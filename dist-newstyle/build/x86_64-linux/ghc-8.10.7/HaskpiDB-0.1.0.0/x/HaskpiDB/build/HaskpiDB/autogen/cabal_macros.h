...
/* package HaskpiDB-0.1.0.0 */
#ifndef VERSION_HaskpiDB
#define VERSION_HaskpiDB "0.1.0.0"
#endif /* VERSION_HaskpiDB */
#ifndef MIN_VERSION_HaskpiDB
#define MIN_VERSION_HaskpiDB(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskpiDB */
...
#define CURRENT_COMPONENT_ID "HaskpiDB-0.1.0.0-inplace-HaskpiDB"
